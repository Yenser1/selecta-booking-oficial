    ...
    return (
        <footer className="bg-black flex flex-col py-7 items-center gap-7">
            ...
            <section className="flex w-full justify-center gap-5 items-center">
                <svg
                    className="hover:scale-110 hover:rotate-5 transition-transform duration-250"
            ...
            <h1 className="border-t-2 border-amber-400 w-full text-center pt-3 text-amber-300">&copy; Todos los derechos reservados</h1>
        </footer>
    );
}
