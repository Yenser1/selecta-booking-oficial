...
function Header() {
    ...
    const HEADERHAM = (
        <header className="header w-full sticky inset-0 z-30 flex  justify-between px-[10vw] items-center pb-3 mb-5 backdrop-blur-md" style={{ borderBottom: "1px solid white" }}>
