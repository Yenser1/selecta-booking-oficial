        ...
        <main className="overflow-x-hidden overflow-y-hidden">
            ...
            <section>
                ...
                <div className="flex flex-wrap gap-5 justify-center items-center">
                    <button key={0} className={`${style === "criollaDominicana"? "selectedStyle":""} bg-yellow-600 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                    ...
                    <button key={1} className={`${style === "comidaRapida"? "selectedStyle":""} bg-red-600 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                    ...
                    <button key={2} className={`${style === "parrillada"? "selectedStyle":""} bg-red-800 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("parrillada")
                        }}
                        style={{
                    ...
                    <button key={3} className={`${style === "marisquerias"? "selectedStyle":""} bg-sky-500 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                    ...
                    <button key={4} className={`${style === "italiana"? "selectedStyle":""} bg-green-700 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("italiana")
                        }}
                        style={{
                    ...
                    <button key={5} className={`${style === "china"? "selectedStyle":""} bg-red-700 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("china")
                        }}
                        style={{
                    ...
                    <button key={6} className={`${style === "mexicana"? "selectedStyle":""} bg-green-600 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("mexicana")
                        }}
                        style={{
                    ...
                    <button key={7} className={`${style === "arabe"? "selectedStyle":""} bg-lime-700 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("arabe")
                        }}
                        style={{
                    ...
                    <button key={8} className={`${style === "japonesa"? "selectedStyle":""} bg-red-500 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("japonesa")
                        }}
                        style={{
                    ...
                    <button key={9} className={`${style === "vegana"? "selectedStyle":""} bg-lime-500 w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("vegana")
                        }}
                        style={{
                    ...
                    <button key={10} className={`${style === "todas"? "selectedStyle":""} bg-[#333] w-max px-1.5 hover:scale-110 transition-all duration-150 rounded-md foodStyle`}
                        onClick={() => {
                            setStyle("todas")
                        }}
                        style={{
